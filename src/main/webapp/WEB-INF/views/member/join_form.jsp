...
<div class="container">
   <form action="joinProcess" id = "add_member_form" method="post">
	 <fieldset>
		...
		<div class = "form-group">
			<button id = "account_rule_btn" type="button" class="btn btn-info" data-toggle="modal" data-target="#account_rule">
   				 회원가입 약관
 		 	</button>
 		 	<button id = "info_rule_btn" type="button" class="btn btn-info" data-toggle="modal" data-target="#info_rule">
   				 개인정보처리방침
 			 </button>
 		 </div>
 		 <div class = "form-group">
 			 <div class="g-recaptcha" data-sitekey=6LfgOM4UAAAAAJg9CHiuPnsjrNKup61971_H3xld></div>
 		 </div>
		 <div class = "form-group">
